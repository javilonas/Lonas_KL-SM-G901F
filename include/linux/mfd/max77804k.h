...
enum {
	MAX77804K_PATH_OPEN = 0,
	MAX77804K_PATH_USB_AP,
	MAX77804K_PATH_AUDIO,
	MAX77804K_PATH_UART_AP,
	MAX77804K_PATH_USB_CP,
	MAX77804K_PATH_UART_CP,
};
...
#define MAX77804K_MOTOR_LRA		(1<<7)
#define MAX77804K_MOTOR_EN		(1<<6)
#define EXT_PWM				(0<<5)
#define MAX77804K_DIVIDER_128		(1<<1)
#define MAX77804K_DIVIDER_256		0x3
