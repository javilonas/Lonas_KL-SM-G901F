...
#define DRIVER_AUTHOR "Paul Reioux <reioux@gmail.com>"
#define DRIVER_DESCRIPTION "Codec Driver Faux Sound control for WCD9330"
#define DRIVER_VERSION "3.6 SM-G901F"
